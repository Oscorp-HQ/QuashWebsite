  ...
  return (
    <section>
      <Head>
        ...
        <meta
          name="description"
          content="Quash has 3 available subscription tiers: a free plan for testing a single app, a paid plan for product teams, and a customisable enterprise plan."
        />
        <link rel="canonical" href={canonicalUrl} />
        <meta
          property="og:title"
          content="Quash - Product Subscriptions and Pricing"
        />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: "Quash",
            description:
              "Quash has 3 available subscription tiers: a free plan for testing a single app, a paid plan for product teams, and a customisable enterprise plan.",
          })}
        </script>
      </Head>
          ...
          <div className=" pt-[130px]  md:pt-[236px]   w-full text-center items-center justify-center flex flex-col ">
            <div className="flex flex-col text-center items-center justify-center w-full mb-[43px] lg:mb-[180px] lg:px-[200px] px-[18px]">
              <motion.h1
                ...
                className="justify-center bg-gradient-to-b  from-white to-gray-500 bg-clip-text text-transparent flex  text-[24px] font-[700] md:text-[66px] text-[#ECECEE] md:font-[600] w-full text-center leading-[1.25] "
              >
