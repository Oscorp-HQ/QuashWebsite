...
const Watson = () => {
  ...
  return (
    <section>
      <div className="relative flex flex-col md:gap-0 items-center overflow-hidden ">
        <Head>
        ...
        <div className=" pt-[112px] px-[18px]  md:pt-[210px] lg:px-[242px]  w-full text-center items-center justify-center flex flex-col gap-[32px] md:gap-[122px] ">
          ...
          <div className="flex flex-col gap-8 md:gap-[28px] text-center items-center justify-center w-full">
            ...
            <p className="justify-center text-[16px] w-[290px] font-[300] flex md:text-[24px] text-[#ECECEE] md:font-[400] md:w-[888px] md:px-[100px] md:pb-[40px]">
              Empower your team to deliver exceptional apps faster, while
              ...
              <div className="flex lg:flex-row flex-col lg:gap-[150px] gap-[32px]">
                ...
                <div className="flex flex-col max-w-[311px] md:max-w-[479px] gap-3 ">
                  ...
                  <p className="text-[#9B9B9B] text-[16px] md:text-[28px] ">
                    Watson generates extensive test cases by reading your
                ...
                <div className="flex flex-col max-w-[311px]  md:max-w-[518px] gap-3 lg:ml-10 ml-0">
                  ...
                  <p className="text-[#9B9B9B] text-[16px] md:text-[28px]">
                    Watson smartly imports your Figma designs to check for UI
                    bugs and design inconsistencies in your app.
                  </p>
                </div>
              </div>
        ...
        <div className="h-full w-full overflow-hidden relative flex md:px-4 px-0  flex-col justify-center items-center">
          <div className="relative w-full flex justify-center items-center flex-col overflow-hidden">
            ...
            <p className="text-center text text-[16px] md:text-[24px] lg:text-[32px] pt-5 text-white lg:w-[724px] md:w-[560px] w-[300px] md:flex hidden">
              With AI-driven automation, Watson will help you cut down your
              costs while delivering exceptional experiences to your users.
            </p>
          </div>
        ...
        <div className="h-full w-full overflow-hidden relative flex  flex-col justify-center items-center">
          <div className="relative w-full flex justify-center items-center flex-col overflow-hidden">
            ...
            <p className="text-center text text-[16px] md:text-[24px] lg:text-[32px] text-white lg:w-[938px] md:w-[653px] w-[307px]">
              Watson’s AI models interact with each other in a structured
              manner, ensuring that the testing is accurate and efficient.
            </p>
            ...
            <div className="w-full flex flex-col px-6 justify-center items-center md:gap-36 gap-[60px] md:pt-[188px] pt-[32px] md:pb-[228px] pb-[62px] ">
              <div className="text-white flex lg:flex-row flex-col md:gap-[77px] gap-[40px]">
                <div className="inline-flex flex-col items-start gap-[12px] md:gap-[40px] md:w-[586px]">
                  ...
                  <p className="md:text-[32px] text-[16px] font-normal text-white pl-[26px] md:pl-[0px]">
                    Simply upload your PRD and let Watson generate test cases
              ...
              <div className="text-white flex lg:flex-row flex-col md:gap-[77px] gap-[40px]">
                <div className="inline-flex flex-col items-start gap-[12px] md:gap-[40px] md:w-[586px]">
                  ...
                  <p className="md:text-[32px] text-[16px] font-normal text-white pl-[26px] md:pl-[0px]">
                    Watson will smartly identify your UI flows in Figma, and
                    test for any inconsistencies.
                  </p>
                </div>
              ...
              <div className="text-white flex lg:flex-row flex-col md:gap-[77px] gap-[40px]">
                <div className="inline-flex flex-col items-start gap-[12px] md:gap-[40px] md:w-[586px]">
                  ...
                  <p className="md:text-[32px] text-[16px] font-normal text-white pl-[26px] md:pl-[0px]">
                    Watson will automatically run all the test cases on your
                    app. For every bug, crash, and UI issue that is reported,
                    Watson provides a solution with it.
                  </p>
                </div>
