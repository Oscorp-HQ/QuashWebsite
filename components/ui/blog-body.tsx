...
const BlogBody = ({post }: any) => {
  const { title, content,
    subHeading, subHeadingContent, subHeadingImage ,
    subHeading2, subHeading2Content, subHeading2Image,
    subHeading3, subHeading3Content, subHeading3Image,
    subHeading4, subHeading4Content, subHeading4Image,
    subHeading5, subHeading5Content, subHeading5Image} =
    post.fields;
  ...
  return (
    <>
      ...
      <div className="blogBodysubContent">
        <h3>{subHeading}</h3>
        <p><RichText1 subHeadingContent={subHeadingContent} />{" "} </p>
      ...
      <div className="blogBodysubContent">
        <h3>{subHeading2}</h3>
        <p><RichText2 subHeading2Content={subHeading2Content} /></p>
      ...
      <div className="blogBodysubContent">
        <h3>{subHeading3}</h3>
        <p><RichText3 subHeading3Content={subHeading3Content} /></p>
      ...
      <div className="blogBodysubContent">
        <h3>{subHeading4}</h3>
        <p><RichText4 subHeading4Content={subHeading4Content} /></p>
        {subHeading4Image?.fields?.file?.url && (
          <div>
            <ContentfulImage
              className="blogImageMain "
              alt={`Cover Image for ${title}`}
      ...
      <div className="blogBodysubContent">
        <h3>{subHeading5}</h3>
        <p><RichText5 subHeading5Content={subHeading5Content} /></p>
        {subHeading5Image?.fields?.file?.url && (
          <div>
            <ContentfulImage
              className="blogImageMain "
              alt={`Cover Image for ${title}`}
